...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'pt_integration_b_process_added_artifact"""
    ...
    @function("pt_integration_b_process_added_artifact")
    def _pt_integration_b_process_added_artifact_function(self, event, *args, **kwargs):
