...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'pt_integration_b_run"""
    ...
    @function("pt_integration_b_run")
    def _pt_integration_b_run_function(self, event, *args, **kwargs):
        """Function: Function that: - Sleeps for delay - Generates list of num_artifacts - Returns list of Artifacts to add, remaining number of runs and sample data"""
        try:
