...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'pt_integration_c_run"""
    ...
    @function("pt_integration_c_run")
    def _pt_integration_c_run_function(self, event, *args, **kwargs):
