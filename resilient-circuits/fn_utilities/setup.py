...
setup(
    ...
    entry_points={
        "resilient.circuits.components": [
            ...
            "UtilitiesBinaryToStringListFunctionComponent = fn_utilities.components.utilities_binary_to_string_list:FunctionComponent",
        ...
        "resilient.circuits.selftest": ["selftest = fn_utilities.util.selftest:_selftest_function"]
    }
)