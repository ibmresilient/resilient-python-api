...
class TestUtilitiesCallRestApi:
    ...
    @pytest.mark.parametrize("rest_method, rest_url, rest_headers, rest_body, rest_verify, expected_results", [
        ('POST', "text", {"type": "text", "content": "line1\nline2"}, {"type": "text", "content": "line1\nline2"}, True, {"value": "xyz"}),
        ('OPTIONS', "text", {"type": "text", "content": "line1\nline2"}, {"type": "text", "content": "line1\nline2"}, True, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, rest_method, rest_url, rest_headers, rest_body, rest_verify, expected_results):
