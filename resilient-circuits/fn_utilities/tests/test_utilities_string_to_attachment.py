...
class TestUtilitiesStringToAttachment:
    ...
    @pytest.mark.parametrize("string_to_convert_to_attachment, attachment_name, incident_id, task_id, expected_results", [
        ("text", "text", 123, 123, {"value": "xyz"}),
        ("text", "text", 123, 123, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, string_to_convert_to_attachment, attachment_name, incident_id, task_id, expected_results):
