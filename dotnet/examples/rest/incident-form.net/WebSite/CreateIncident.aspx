...
<body>
    ...
    <form id="IncidentForm" runat="server">
        ...
        <p>
            ...
            <asp:TextBox ID="co3_start_date" runat="server" TextMode="DateTime" />
        </p>
        ...
        <p>
            <label>Negative PR</label>
            <asp:DropDownList ID="co3_negative_pr_likely" runat="server" />
        </p>
        
        <p>
            <label>Reporting Individual (Your Name)</label>
    ...
    <script type="text/javascript">
        ...
        $("#<%=co3_start_date.ClientID %>").datetimepicker();
  </script>
</body>
</html>
    ...
    protected override void OnHandleException(Exception ex, string message)
    {
        ...
        if (_co3_error_detail != null)
        {
            ...
            if (!string.IsNullOrEmpty(message))
                _co3_error_detail.InnerText += string.Format(" ({0})", message);
        }
    }
