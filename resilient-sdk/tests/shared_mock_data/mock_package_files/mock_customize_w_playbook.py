...
def codegen_reload_data():
    ...
    return {
        ...
        "message_destinations": [u"fn_main_mock_integration"],
        ...
        "actions": [u"Mock Manual Rule", u"Mock Task Rule", u"Mock: Auto Rule"],
        "incident_fields": [u"mock_field_number", u"mock_field_text_area"],
        ...
        "scripts": [u"Mock Script One"],
        "playbooks": [u"main_mock_playbook"]
    }
