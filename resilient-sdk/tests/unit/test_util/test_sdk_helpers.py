...
def test_get_resilient_circuits_version_to_use():
    assert sdk_helpers.get_resilient_circuits_version_to_use() == sdk_helpers.RESILIENT_CIRCUITS_VERSION


def test_get_resilient_circuits_version_to_use_dev(fx_add_dev_env_var):
    assert sdk_helpers.get_resilient_circuits_version_to_use() == sdk_helpers.RESILIENT_CIRCUITS_VERSION_DEV
