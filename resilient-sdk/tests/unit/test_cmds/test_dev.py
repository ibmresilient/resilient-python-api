...
def test_set_version_bad_version_51_or_greater(fx_copy_fn_main_mock_integration, fx_get_sub_parser, fx_cmd_line_args_dev_set_bad_version_51):
    ...
    with pytest.raises(SDKException, match=r"or v51\+ version must include five numbers, in the format: v.r.m.f.build_number"):
        CmdDev._set_version(args)
...
def test_set_version_51_or_greater(fx_copy_fn_main_mock_integration, fx_get_sub_parser, fx_cmd_line_args_dev_set_version_51):
